...
public class FirmwareUtils {
    ...
    public static final int PACKAGED_FIRMWARE_VER = 1;
    private static final int FIRMWARE_FILE_1_ID = R.raw.v1_kv4p_ht_esp32_wroom_32_ino_bootloader;
    private static final int FIRMWARE_FILE_2_ID = R.raw.v1_kv4p_ht_esp32_wroom_32_ino_partitions;
    private static final int FIRMWARE_FILE_3_ID = R.raw.boot_app0; // This one never changes, it's the Arduino ESP32 bootloader
    private static final int FIRMWARE_FILE_4_ID = R.raw.v1_kv4p_ht_esp32_wroom_32_ino;
