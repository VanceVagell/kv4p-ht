...
extern const uint8_t FIRMWARE_VER[8];   // Should be 8 characters representing a zero-padded version, like 00000001.
extern const uint8_t VERSION_PREFIX[7]; // Must match RadioAudioService.VERSION_PREFIX in Android app.

// Delimeter must also match Android app
#define DELIMITER_LENGTH 8
extern const uint8_t delimiter[DELIMITER_LENGTH];
...
#define MAX_COMMAND_PARAMS_LENGTH 17
#define FILTERS_PARAMS_LENGTH 3

// Maximum number of milliseconds to wait for the android app before giving up the command
#define COMMAND_TIMEOUT_MICROS 500000
